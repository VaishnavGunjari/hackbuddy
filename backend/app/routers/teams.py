    ...
    if team_res.data:
        ...
        if leader_res.data and requester_res.data:
            ...
            send_email_notification(
                ...
                body=f"Hi {leader['full_name']},\n\n{requester['full_name']} has requested to join your team '{team['name']}' on HackMate.\n\nReview the request on your team dashboard."
            )
...
async def accept_join_request(
    ...
    if user_res.data and team_info.data:
        ...
        send_email_notification(
            ...
            body=f"Hi {user['full_name']},\n\nCongratulations! Your request to join '{team_name}' has been accepted on HackMate. Time to check the team's chat!"
        )
